...
class Battery(Initialise):
    ...
    def draw_rect(self):
        ...
        pygame.draw.rect(Initialise.screen, Battery.WHITE,
                         (800, 25, 150, 100), 3)
        # the below code is the original version
        # pygame.draw.rect(self.screen, Battery.GREEN, (802, 27, 145, 97))
        if self.x != 145:
            pygame.draw.rect(Initialise.screen, Battery.GREEN, (802, 27, self.x, 97))
            self.x += 1
##        pygame.draw.rect(Initialise.screen, Battery.GREEN,(803, 27, self.x, 97))
...
class UpdateValues(Initialise):
    ...
    def __init__(self):
        ...
        self.speed_value = -17.818
        self.speed_value_original = 200
##
