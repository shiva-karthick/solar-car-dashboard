...
#picamera command def
def UseCamera():
    global state 
    if stating==True:
        camera.preview_fullscreen = False
        camera.preview_window = (600, 200, 320, 240)
...
startButton = tk.Button(tbFrame, text='Camera', relief="sunken", borderwidth=5,width=5,
                    bg="white", fg="black", font=("Franklin Gothic Medium", 16) ,command=UseCamera)
ssvLabel = tk.Label(tbFrame, text='SUNSPEC 5 Telemetry System', relief="sunken", borderwidth=5, width=5,
                    bg="white", fg="Red", font=("SF Sports Night", 16))
...
tempLabel = tk.Label(auxFrame, text='Temp', borderwidth=5,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
tempUnit = tk.Label(auxFrame, text='C', borderwidth=5, width=2,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
rpmLabel = tk.Label(auxFrame, text='RPM', borderwidth=5,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
rpmUnit = tk.Label(auxFrame, text='rpm', borderwidth=5, width=2,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
motorPowerLabel = tk.Label(auxFrame, text='Motor Power', borderwidth=5,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
motorPowerUnit = tk.Label(auxFrame, text='kWh', borderwidth=5, width=2,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
string1Label = tk.Label(auxFrame, text='String 1', borderwidth=5,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
string1Unit = tk.Label(auxFrame, text='kWh', borderwidth=5, width=2,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
string2Label = tk.Label(auxFrame, text='String 2', borderwidth=5,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))
string2Unit = tk.Label(auxFrame, text='kWh', borderwidth=5, width=2,
                    fg= "Green", bg= "black", relief="sunken", font=("Franklin Gothic Medium", 24))

#values displayed
timeValue = tk.Label(tbFrame, textvariable=myTime, borderwidth=5, anchor=('e'),width=4,
                    fg= "black", bg= "white", relief="sunken", font=("digital-7", 16))
...
batteryFrame.columnconfigure(0, weight=3)
...
speedFrame.columnconfigure(0, weight=3)
speedFrame.columnconfigure(1, weight=2)
speedFrame.columnconfigure(2, weight=2)

auxFrame.grid(row=2, column=3, rowspan=4, columnspan=5, stick=('N','S','E','W'))
...
auxFrame.columnconfigure(0, weight=1)
auxFrame.columnconfigure(1, weight=1)
auxFrame.columnconfigure(2, weight=1)
...
tempLabel.grid(row=0, column=0, rowspan=1, sticky=('N','S','E','W'))
tempValue.grid(row=0, column=1, rowspan=1, sticky=('N','S','E','W'))
tempUnit.grid(row=0, column=2, rowspan=1, sticky=('N','S','E','W'))                
rpmLabel.grid(row=1, column=0, rowspan=1, sticky=('N','S','E','W'))
rpmValue.grid(row=1, column=1, rowspan=1, sticky=('N','S','E','W'))
rpmUnit.grid(row=1, column=2, rowspan=1, sticky=('N','S','E','W'))
motorPowerLabel.grid(row=2, column=0, rowspan=1, sticky=('N','S','E','W'))
motorPowerValue.grid(row=2, column=1, rowspan=1, sticky=('N','S','E','W'))
motorPowerUnit.grid(row=2, column=2, rowspan=1, sticky=('N','S','E','W'))
...
string1Label.grid(row=3, column=0, sticky=('N','S','E','W'))
string1Value.grid(row=3, column=1, sticky=('N','S','E','W'))
string1Unit.grid(row=3, column=2, sticky=('N','S','E','W'))
string2Label.grid(row=4, column=0, sticky=('N','S','E','W'))
string2Value.grid(row=4, column=1, sticky=('N','S','E','W'))
string2Unit.grid(row=4, column=2, sticky=('N','S','E','W'))
